...
const Vedio = () => {
  ...
  return (
    <div className="relative w-full mx-auto h-[300px] md:h-[600px]">
      {/* Video */}
      ...
      {/* Card on bottom left */}
      <div className="absolute bottom-4 left-4 bg-white p-4 rounded-lg shadow-lg flex flex-col items-start space-x-2 max-w-xs">
        {/* User avatars */}
        <div className="flex flex-row gap-2 justify-start">
          <img
            src="https://cdn.prod.website-files.com/66a9edf7bd0139f5207e19be/66db342e29294df7682b40e8_Avatar%201.avif"
            alt="Avatar 1"
            className="w-10 h-10 rounded-full border-2 border-white cursor-pointer hover:border-green-600 hover:border-2"
            onClick={() =>
              handleAvatarClick(
                "https://res.cloudinary.com/diqmvbeg6/video/upload/v1727308210/06-HOME-hero_nyz3a8.mp4"
              )
        ...
        {/* Text in the card */}
        <div>
          <p className="border-2 border-gray-200 rounded-full w-full mb-2"></p>

          <p className="text-purple-600">Script</p>
